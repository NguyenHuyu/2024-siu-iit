...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
   ...
   return {
      ...
      openGraph: {
         ...
         type: 'website',
         locale: 'vi_VN',
         url: `https://iit.siu.edu.vn/${params.lang}/cong-bo-khoa-hoc/${customSlugify(news.title)}__${news.id}.html`,
         images: [
            {
               url: news.imageUrl,
               width: 800,
   ...
   return (
      <Fragment>
         ...
         <Suspense fallback={<RecommendedProductsSkeleton />}>
            <RecommendedProducts
               lists={[Category.PUBLICATIONS]}
               id={getUrlParams(params.id as string)}
               params={`${params.lang}/cong-bo-khoa-hoc`}
            />
         </Suspense>
      </Fragment>
   )
