...
export default function RenderItem({ bulletin }: { bulletin: Bulletin }) {
   return (
      <div className='py-6 px-4 sm:p-6 md:py-28 md:px-8 container'>
         <div className='max-w-4xl items-center mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-10 lg:grid-cols-2'>
            <div className='relative p-3 rounded-lg bg-gradient-to-t from-black/75 via-black/0 sm:bg-none'>
               ...
               <p className='mt-4 text-base leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-400'>
                  {bulletin.description}
               </p>
            </div>
            <div className='sm:mb-6 lg:gap-6 lg:mb-0 rounded-md'>
               <Image
         ...
         <div className='max-w-4xl mx-auto lg:max-w-5xl lg:gap-x-20 py-4'>
